...
namespace oe::service {
    class modbusRtuServiceAPI {
        public:
            ...
            bool write_holding_registers(const uint16_t address, vector<uint16_t> data) { return _client.CallMethod<bool>(2, "write_holding_registers", { address, data }); }
            bool write_holding_register(const uint16_t address, uint16_t data) { return _client.CallMethod<bool>(3, "write_holding_register", { address, data }); }
