 ...
 * @brief MQTT Data Bridge (broking data & data inserting to db server)
 * @version 0.1
 * @date 2022-08-03
 * 
...
{
    string desc = fmt::format("MQTT Data Bridge Middleware (built {}/{})",__DATE__, __TIME__);
    cxxopts::Options options("MQTT Data Bridge Middleware", desc.c_str());
    options.add_options()
