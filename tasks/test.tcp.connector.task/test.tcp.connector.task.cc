...
#include "test.tcp.connector.task.hpp"
#include <openedge/log.hpp>
#include <openedge/common/uart.hpp>

//static component instance that has only single instance
static test_tcp_connector_task* _instance = nullptr;
core::task::runnable* create(){ if(!_instance) _instance = new test_tcp_connector_task(); return _instance; }
void release(){ if(_instance){ delete _instance; _instance = nullptr; }}

test_tcp_connector_task::test_tcp_connector_task(){
...
void test_tcp_connector_task::execute(){
...
void test_tcp_connector_task::stop(){

}

bool test_tcp_connector_task::configure(){
    if(_device)
        _device->close();
...
void test_tcp_connector_task::cleanup(){
    if(_device){
        _device->close();
        delete _device;
    }
...
void test_tcp_connector_task::pause(){
    
}

void test_tcp_connector_task::resume(){
    
}

void test_tcp_connector_task::on_request(std::any data){
