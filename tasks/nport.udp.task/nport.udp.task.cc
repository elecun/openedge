...
#include "nport.udp.task.hpp"
#include <openedge/log.hpp>


//static component instance that has only single instance
static nportUdpTask* _instance = nullptr;
oe::core::task::runnable* create(){ if(!_instance) _instance = new nportUdpTask(); return _instance; }
void release(){ if(_instance){ delete _instance; _instance = nullptr; }}


bool nportUdpTask::configure(){
...
void nportUdpTask::pause(){

}

void nportUdpTask::resume(){
