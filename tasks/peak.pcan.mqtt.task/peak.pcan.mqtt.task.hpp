/**
 * @file    peak.pcan.mqtt.task.hpp
 * @brief   Peak CAN Ethernet Gateway to JSONized MQTT Re-transferring
 * @author  Byunghun Hwang<bh.hwang@iae.re.kr>
 */

#ifndef _OPENEDGE_PEAK_PCAN_MQTT_TASK_HPP_
#define _OPENEDGE_PEAK_PCAN_MQTT_TASK_HPP_
...
class peakPcanMqttTask : public oe::core::task::runnable, private mosqpp::mosquittopp {
    ...
    public:
        peakPcanMqttTask():mosqpp::mosquittopp(){};
        virtual ~peakPcanMqttTask() = default;
