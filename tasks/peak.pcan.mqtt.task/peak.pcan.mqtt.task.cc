...
#include "peak.pcan.mqtt.task.hpp"
#include <openedge/log.hpp>


//static component instance that has only single instance
static peakPcanMqttTask* _instance = nullptr;
oe::core::task::runnable* create(){ if(!_instance) _instance = new peakPcanMqttTask(); return _instance; }
void release(){ if(_instance){ delete _instance; _instance = nullptr; }}


bool peakPcanMqttTask::configure(){
...
void peakPcanMqttTask::pause(){

}

void peakPcanMqttTask::resume(){

}


void peakPcanMqttTask::on_connect(int rc){
...
void peakPcanMqttTask::on_disconnect(int rc){

}

void peakPcanMqttTask::on_publish(int mid){
    
}

void peakPcanMqttTask::on_message(const struct mosquitto_message* message){
    
}

void peakPcanMqttTask::on_subscribe(int mid, int qos_count, const int* granted_qos){
    
}

void peakPcanMqttTask::on_unsubscribe(int mid){

}

void peakPcanMqttTask::on_log(int level, const char* str){

}

void peakPcanMqttTask::on_error(){

}

void peakPcanMqttTask::process_pcan_data(S_LAN_MSG* p_msg){
...
int peakPcanMqttTask::parse_pcan_data(unsigned char * p_buff, int len, S_LAN_MSG *p_msg){
...
int peakPcanMqttTask::print_pcan_data(S_LAN_MSG* p_msg){
    unsigned int i;
